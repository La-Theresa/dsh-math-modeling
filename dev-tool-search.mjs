 ...
 * str_replace_editor + the discovery tools + math_code) instead of dumping the whole
...
export function apply(ctx) {
  ctx.tools.register({
    ...
    description: [
      ...
      '',
      'This session starts with a minimal resident set: bash, str_replace_editor, skill_search, skill_load, math_code, and background job tools when available. Everything else is unlocked on demand through this tool.',
      '',
